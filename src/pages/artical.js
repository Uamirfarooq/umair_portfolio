...
const Article = ({ img, title, date, link }) => {
  return (
    <motion.li className=' relative w-full p-4 py-6 my-4 rounded-xl flex sm:flex-col items-center justify-between bg-light text-dark first:mt-0 border border-solid border-dark border-r-4 border-b-4 dark:border-light dark:text-light dark:bg-dark'
      initial={{ y: 200 }}
      whileInView={{ y: 0 }}
    // viewport={{once:true}}
    >
    ...
    <>
      ...
      <main className='dark:text-light w-full mb-16 flex flex-col  items-center justify-center overflow-hidden'>
        ...
        <ul className='mb-60'>
          ...
          <Article title="Form Validation In Reactjs: Build A Reusable Custom Hook For aaaInputs And Error Handling"
            date="Match 22, 2023"
            link="/"
            img={article3}
          />
